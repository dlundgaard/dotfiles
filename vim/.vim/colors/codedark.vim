...
"let s:cdBack = {'gui': '#1E1E1E', 'cterm': s:cterm00, 'cterm256': '233'}
let s:cdBack = s:cdNone

let s:cdTabCurrent = {'gui': '#151515', 'cterm': s:cterm00, 'cterm256': '233'}
let s:cdTabOther = {'gui': '#2D2D2D', 'cterm': s:cterm01, 'cterm256': '236'}
let s:cdTabOutside = {'gui': '#252526', 'cterm': s:cterm01, 'cterm256': '233'}

let s:cdLeftDark = {'gui': '#252526', 'cterm': s:cterm01, 'cterm256': '233'}
...
let s:cdCursorDarkDark = {'gui': '#222222', 'cterm': s:cterm01, 'cterm256': '233'}
